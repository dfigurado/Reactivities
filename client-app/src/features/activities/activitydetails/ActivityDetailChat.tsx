...
const ActivityDetailChat = () => {
  ...
  const { activity, clearActivity, addComment, createHubConnection, stopHubConnection } = rootStore.activityStore;
  ...
  }, [activity, clearActivity, createHubConnection, stopHubConnection])
